...
{
	// Match Style
	arr = ruleCvarDefault(arr, "scr_ctf_timelimit", 0);		// Time limit. When halftime is enabled, its time limit per half. 0=disabled (minutes)
	...
	// Halftime
	arr = ruleCvarDefault(arr, "scr_ctf_halftime", 0);		// Do halftime. When 1, scr_ctf_timelimit means time per half
