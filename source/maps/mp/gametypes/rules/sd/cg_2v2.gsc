...
Load()
{
	...
	game["leagueString"] = &"S&D 2v2 Ladder Mode";
...
GetCvars()
{
	...
	*********/
	...
	arr = ruleCvarDefault(arr, "scr_allow_springfield", 0);
	...
	arr = ruleCvarDefault(arr, "scr_allow_enfieldsniper", 0);
	...
	arr = ruleCvarDefault(arr, "scr_allow_nagantsniper", 0);
	...
	arr = ruleCvarDefault(arr, "scr_allow_kar98ksniper", 0);
