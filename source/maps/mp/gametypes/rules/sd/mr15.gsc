...
Load()
{
	...
	game["leagueStringOvertime"] = &"S&D MR15 Mode  ^3Overtime";
...
GetCvars()
{
	...
	arr = ruleCvarDefault(arr, "scr_sd_half_round", 15);	// Number of rounds when half-time starts. 0=ignored
	arr = ruleCvarDefault(arr, "scr_sd_half_score", 0);	// Number of score when half-time starts. 0=ignored
	arr = ruleCvarDefault(arr, "scr_sd_end_round", 30);	// Number of rounds when map ends. 0=ignored
	arr = ruleCvarDefault(arr, "scr_sd_end_score", 16);	// Number of score when map ends. 0=ignored
