...
{
	game["leagueLogo"] = "";
	game["leagueString"] = &"S&D PCW mode";
...
GetCvars()
{
	...
	*******************************/
	...
	arr = ruleCvarDefault(arr, "scr_readyup_autoresume", 0); 	// Minutes to auto-resume halftime [0 - 10] 0 = disabled
	...
	arr = ruleCvarDefault(arr, "scr_recording", 0); 						// Starts automatically recording when match startsrone again will be increased)
	...
	*********/
	...
	arr = ruleCvarDefault(arr, "scr_no_oneshot_ppsh_kills", 1);

	// PPSH Balance - Limits range of PPSH to same as Tommy
	arr = ruleCvarDefault(arr, "scr_balance_ppsh_distance", 1);
