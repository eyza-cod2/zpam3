...
{
	// Match Style
	arr = ruleCvarDefault(arr, "scr_tdm_timelimit", 30);		// Time limit. When halftime is enabled, its time limit per half. 0=disabled (minutes)
	...
	// Halftime
	arr = ruleCvarDefault(arr, "scr_tdm_halftime", 0);			// Do halftime. When 1, scr_tdm_timelimit means time per half
