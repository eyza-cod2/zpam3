...
init()
{
	...
	if(game["firstInit"])
	{
		...
		precacheString2("STRING_PAM_MUST_EXISTS_UNDER_MAIN", &"Iwd file ^9zpam400_test4.iwd^7 must be installed in ^9main^7 folder."); // ZPAM_RENAME
	...
	level.pam_folder = "main/zpam400_test4"; // ZPAM_RENAME
