...
generateMatchDescription()
{
	...
	level.match_description = 
		"Match | " + getCvar("sv_hostname") + "\n" +
		"Team 1:  [^8" + removeColorsFromString(matchGetData("team1_name")) + "^7]:  " + players1 + "\n" +
		"Team 2:  [^9" + removeColorsFromString(matchGetData("team2_name")) + "^7]:  " + players2 + "\n";

	if (playersUnknown != "")
		level.match_description += "^3Unknown players: " + playersUnknown + "\n";
