Rules()
{
	...
	setcvar("scr_sd_half_round", 3);	// Number of rounds when half-time starts. 0=ignored
	setcvar("scr_sd_half_score", 0);	// Number of score when half-time starts. 0=ignored
	setcvar("scr_sd_end_round", 6);		// Number of rounds when map ends. 0=ignored
	setcvar("scr_sd_end_score", 4);		// Number of score when map ends. 0=ignored
