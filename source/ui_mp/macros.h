...
\
	MATCHINFO_STREAMER_TEXT(0 10,    HORIZONTAL_ALIGN_CENTER, "sv_hostname", 	                	.15, ITEM_ALIGN_CENTER, ITEM_TEXTSTYLE_NORMAL, UI_FONT_NORMAL, 1 1 1 1, cvar_show, showDvar { "1" }) \
