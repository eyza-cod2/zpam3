...
- MG - damage change to 100hp for head+neck, 75hp for body, and 35hp for other parts
...
- Sound "hit" feedback is now being played only once for shotgun hits/kills, not for each pellet
